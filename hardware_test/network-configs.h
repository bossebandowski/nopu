...
void load_nn_cifar_10()
{
    ...
    // weight addresses
    cop_config(0, 2, &param_2_w_conv);
    cop_config(1, 2, 0);
    cop_config(2, 2, &param_3_w_conv);
    cop_config(3, 2, 0);
    cop_config(4, 2, &param_7_w_fc);
    cop_config(5, 2, &param_8_w_fc);
    ...
    cop_config(3, 3, 0);
    cop_config(4, 3, &param_7_b);
    cop_config(5, 3, &param_8_b);
